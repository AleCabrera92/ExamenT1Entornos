...
document.querySelector("#botonWhite").onclick = buttonTest

function buttonTest() {
    let link = document.querySelector("#estilos")
    if(link.hasAttribute("href")){
      link.setAttribute("href", "css/whitestyle.css");
    }
};
...
document.querySelector("#botonBlack").addEventListener('click', () => {
    let link = document.querySelector("#estilos")
    if(link.hasAttribute("href")){
      link.setAttribute("href", "css/blackstyle.css");
    }
});
...
document.querySelector("#checkboxPassword").onclick = showPassword
...
function mostrarCantidadesAnalisis(infoPassword){
 ...
 var allChars = document.querySelector("#cantTotalCaracteres")
 var cantNumeros = document.querySelector("#cantNum")
 var cantEsp = document.querySelector("#cantEspeciales")
 var cantLet = document.querySelector("#cantLetras")
 var cantLetMin = document.querySelector("#cantLetrasMinus")
 var cantLetMayus = document.querySelector("#cantLetrasMayus")
 var cantIguales = document.querySelector("#cantIguales")
 var cantCons = document.querySelector("#cantConsecutivos")
 var cantDis = document.querySelector("#cantDistintos")

 allChars.innerHTML = infoPassword.cantTotalCaracteres;
 cantNumeros.innerHTML = infoPassword.cantNum;
 cantEsp.innerHTML = infoPassword.cantCaracteresEspeciales;
 cantLet.innerHTML = infoPassword.cantLetras;
 cantLetMayus.innerHTML = infoPassword.cantLetrasMayusculas;
 cantLetMin.innerHTML = infoPassword.cantLetrasMinusculas;
 cantIguales.innerHTML = infoPassword.cantIguales;
 cantDis.innerHTML = infoPassword.cantDistintos;
 cantCons.innerHTML = infoPassword.cantConsecutivos;
}
